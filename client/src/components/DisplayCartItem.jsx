...
const DisplayCartItem = ({ close }) => {
  ...
  return (
    <section className='bg-neutral-900 fixed top-0 bottom-0 right-0 left-0 bg-opacity-10 z-50'>
      <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
        ...
        <div className='min-h-[75vh] lg:min-h-[80vh] h-full max-h-[calc(100vh-150px)] bg-blue-50 p-2 flex flex-col gap-4'>
          {/***display items */}
          {
            cartItem[0] ? (
              <>
                <div className='flex items-center justify-between px-4 py-2 bg-blue-100 text-blue-500 rounded-full'>    <p>Your total savings</p>
